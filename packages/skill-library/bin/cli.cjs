...
const REPO_NAME = 'universal-cms';
const BRANCH = 'main';
const SKILLS_PREFIX = 'packages/skill-library';

function raw(filePath) {
  return `https://raw.githubusercontent.com/${REPO_OWNER}/${REPO_NAME}/${BRANCH}/${SKILLS_PREFIX}/${filePath}`;
}
