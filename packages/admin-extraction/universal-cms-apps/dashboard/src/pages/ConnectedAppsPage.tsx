...
import { Globe, ExternalLink, RefreshCw, CheckCircle, AlertTriangle, XCircle, HelpCircle } from 'lucide-react';
import type { ConnectedApp } from '../lib/types';

// In v1, we use localStorage as a simple store.
// In production, this would be a Supabase table on the dashboard's own project.
function getApps(): ConnectedApp[] {
  try {
