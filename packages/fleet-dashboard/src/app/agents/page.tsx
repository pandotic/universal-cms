...
export default function AgentsPage() {
  ...
  if (!adminConfig.features.agents) {
    return (
      <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 p-6 text-center">
        ...
        <p className="mt-1 text-sm text-amber-400/70">
          Agent workflows are not enabled in this configuration.
        </p>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Manage automated workflows across properties
          </p>
        </div>
        <button
      ...
      {loading ? (
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-12 text-center">
          ...
          <p className="mt-1 text-xs text-zinc-600">
            Create an agent to automate tasks for your properties
          </p>
        </div>
      ) : (
