...
function getDirectoryTools(config: CmsConfig): Tool[] {
  return [
    {
      name: "list_entities",
      description: `List directory ${config.primaryEntity.plural} with optional filters. Returns id, name, slug, type, status.`,
      input_schema: {
        type: "object" as const,
        properties: {
          status: {
    ...
    {
      name: "get_entity",
      description: `Get a single ${config.primaryEntity.singular} by ID or slug.`,
      input_schema: {
        type: "object" as const,
        properties: {
          id: { type: "string" },
    ...
    {
      name: "create_entity",
      description: `Create a new ${config.primaryEntity.singular} in the directory.`,
      input_schema: {
        type: "object" as const,
        properties: {
    ...
    {
      name: "update_entity",
      description: `Update an existing ${config.primaryEntity.singular} by ID.`,
      input_schema: {
        type: "object" as const,
        properties: {
